...
import time 
elhypamody = '5917983447'
bot = telebot.TeleBot(Config.TG_BOT_TOKEN)
p3 = types.InlineKeyboardMarkup()
p5 = types.InlineKeyboardButton(text = "🔱 𓀛سورس الفراعنة𓀞🔱",url="t.me/wasit_go")
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/co_od")
		p3.add(e4)
		h = """[مطور السورس .](t.me/co_od)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    url = ["https://graph.org/file/9e90986cd4964303776a8.jpg","https://graph.org/file/9e90986cd4964303776a8.jpg","https://graph.org/file/9e90986cd4964303776a8.jpg","https://graph.org/file/9e90986cd4964303776a8.jpg"]
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/wasit_go")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/co_od")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس الفراعنة
[قناة السورس .](t.me/wasit_go)
[مطور السورس .](t.me/co_od)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 𓀛سورس الفراعنة𓀞🔱",url="t.me/wasit_go")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @wasit_go*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "🔱 𓀛سورس الفراعنة𓀞🔱",url="t.me/wasit_go")
	p3.add(p5)
...
- @Sss0s0bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
		...
		bot.reply_to(message,"اسمي ↫ ًســـــرو افتهم عادد")
